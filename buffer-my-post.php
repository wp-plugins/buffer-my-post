...
define('bmp_opt_post_type',"post");
   ...
   function bmp_admin_actions() {
        add_menu_page("Buffer My Post", "Buffer My Post", 'manage_options', "BufferMyPost", "bmp_admin");
        add_submenu_page("BufferMyPost", __('Exclude Posts','BufferMyPost'), __('Exclude Posts','BufferMyPost'), 'manage_options', __('BMPExcludePosts','BufferMyPost'), 'bmp_exclude');
