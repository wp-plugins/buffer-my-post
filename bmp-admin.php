...
{author}: the post author <br/>
                        ...
                        <div class="option">
                        <label for="bmp_opt_acnt_type">' . __('Accounts:<br/> <span class="desc">What accounts do you want to post?<span>', 'BufferMyPost') . '</label><br/>
<br/>
			...
			print(
				...
				'Please check your Token.</p>'
				    	...
				    	<div style="float:left">
						    	<label class="catlabel">' . __('Categories to Omit from posts: <br/><span class="desc">(Check categories not to share.)<span> ', 'BufferMyPost') . '</label> </div><br/>
<br/>
						    	<div style="float:left">
